...
const App = () => {
  ...
  /** utilizando hook personalizados (echos por personalmente) */
  const [persons2, setPerson2] = useResource('http://localhost:3005/persons')
  ...
  */
  ...
  return (
    <div>
      ...
      <h2>Numbers</h2>
      <Numbers people={persons2} input={filter} setPerson={setPersons} />
    </div>
  )
}
export default App
